...
def build_connection_str(
    name:str, triple_store_type:str, triple_store_url:str, model_graphs:List[str], data_graph:str, extra_data_graphs:List[str]=[]
    ):
    '''
    Throw exception if connection triplestore(s) don't respond OK to http GET
    ...
    # :param model_graphs: list of model graphs e.g. ["uri://my_graph", "http://my/other#graph"]
    # :param data_graph: default ingestion data graph e.g. "uri://my_graph"
    # :param extra_data_graphs: list of data graphs with ["uri://my_graph", "http://my/other#graph"]
...
def delete_item_from_store(item_id, item_type):
    ...
    :param item_type: one of STORE_ITEM_TYPE
    '''
    store_client = __get_nodegroup_store_client()
